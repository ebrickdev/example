module github.com/ebrickdev/example

go 1.22.5

require (
	github.com/ebrickdev/ebrick v0.13.1
	...
	github.com/ebrickdev/extensions/v1/security/auth/oidc v0.0.0-20250212051141-23d81d669698
